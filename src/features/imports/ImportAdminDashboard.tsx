...
function ImportSidebar({ active }: { active: "operations" | "imports" }) {
  return (
    <aside className="sidebar" aria-label="hub-om 메뉴">
      ...
      <nav className="nav-list">
        <Link className={active === "operations" ? "active" : ""} href="/">
          운영 목록
        </Link>
        <Link className={active === "imports" ? "active" : ""} href="/admin/imports">
          데이터 검수
        </Link>
      </nav>
    </aside>
