...
const FIELD_ALIASES: Record<string, string[]> = {
  ...
  courseId: ["courseid", "coursecode", "코스id", "코스아이디", "과정id", "과정코드", "과정id코스id"],
  courseName: ["course", "coursename", "program", "programname", "과정", "과정명", "교육명", "프로그램명"],
  driveLink: ["drive", "drivelink", "googledrive", "구글드라이브", "드라이브", "드라이브링크", "구글드라이브링크", "폴더", "폴더링크"],
  ...
  operationDetail: ["operationdetail", "syncup", "싱크업", "싱크업링크", "운영상세", "상세링크"],
  ...
  region: ["region", "지역", "장소", "교육장소", "교육장장소"],
