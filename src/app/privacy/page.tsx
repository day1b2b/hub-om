      ...
      <article className="legal-document">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Google Calendar 일정 데이터: 사용자가 선택하거나 hub-om에서 생성한 일정의 캘린더
              식별자, 일정 식별자, 제목, 설명, 시작·종료 시각, 시간대, 원문 링크와 API 처리 상태
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            hub-om은 원본 스프레드시트를 수정하거나 삭제하지 않습니다.
          </p>
          <p>
            사용자가 일정 생성·수정·삭제 기능을 실행하거나 사용자가 설정한 교육 일정 동기화를
            수행하면 hub-om은 사용자 본인이 승인한 Google Calendar OAuth 권한을 사용합니다. 대상은
            사용자의 기본 캘린더와 사용자가 편집할 수 있는 회사 공유 캘린더로 제한됩니다.
          </p>
          <p>
            hub-om은 교육 일정의 제목, 설명, 시작·종료 시각과 일정 식별자를 처리할 수 있지만,
            캘린더의 공유 권한, 액세스 제어 목록(ACL), 소유권 또는 기타 캘린더 설정은 변경하지
            않습니다.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Google 계정에서 OAuth 권한을 철회하면 이후의 Google API 접근은 중단되지만, 철회 전에
            Google Calendar에 생성된 일정이 자동으로 삭제되지는 않습니다. 사용자는 hub-om의 일정
            삭제 기능 또는 Google Calendar에서 해당 일정을 삭제할 수 있습니다.
          </p>
        </section>
