...
최종보완: validation-v2의writer목록/guard수명/실제경합관찰수락기준 적용. PG잠금후engagement재조회, selfGETaccesslog도동일코치락참여. guard 준비는shadow허용표시필수이고기존guard구성불일치는자동수리하지않고failclosed. 최초guard upsert duplicate도전체tx재시도.
